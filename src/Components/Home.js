                    ...
                    <div className='row'>
                        <div className='col mb-4' sm={8}>
                            <div className='border rounded text-center shadow shadow-3 p-3'>
                                <br></br>
                                <h3><b>Ambulance Services</b></h3>
                                <hr className='mx-auto w-50'></hr>
                                <p>
                                    Find the nearest ambulance driver details!!
                                </p>
                                
                                <button className='btn btn-primary'>
                                    <Link className='text-white' to="/ambudetails" style={{ textDecoration: "none" }}>Click here</Link>
                                </button>
                                <br></br>
                                <br></br>
                            </div>
                        ...
                        <div className='col mb-4' sm={8}>
                            <div className='border rounded text-center shadow shadow-3 p-3'>
                                <br></br>
                                <h3><b>Hospital Services</b></h3>
                                <hr className='mx-auto w-50'></hr>
                                
                                <p>
                                    We provide you nearest hospital's information.
                                </p>
                                
                                <button className='btn btn-primary'>
                                    <Link className='text-white' to="/hospitaldetails" style={{ textDecoration: "none" }}>Click here</Link>
                                </button>
                                <br></br>
                                <br></br>
                            </div>
